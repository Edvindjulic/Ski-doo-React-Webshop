...
export default function ConfirmBooking() {
  ...
  return (
    ...
    >
      ...
      <Card variant="outlined" sx={{ width: '90%', margin: '0.8rem 0', backgroundColor: 'white', height: '5rem', border: '1px solid black' }}>
        <CardContent 
          sx={{
            display: 'flex',
      ...
      >
        ...
        <Typography variant="subtitle1">SvenssonGatan 10, 123 45, Svenninge</Typography>
